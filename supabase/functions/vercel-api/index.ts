...
const ALLOWED = [
  ...
  /^\/v9\/projects\/[^/]+\/pause$/,
  /^\/v9\/projects\/[^/]+\/unpause$/,
  /^\/v9\/projects\/[^/]+\/transferRequest$/,
  /^\/v9\/projects\/[^/]+\/custom-environments$/,
  /^\/v9\/projects\/[^/]+\/redirects(\/[^/]+)?$/,
  /^\/v6\/deployments$/,
  /^\/v13\/deployments$/,
  /^\/v13\/deployments\/[^/]+$/,
  ...
  /^\/v6\/deployments\/[^/]+\/files(\/[^/]+)?$/,
  /^\/v7\/deployments\/[^/]+\/files\/[^/]+$/,
  /^\/v9\/projects\/[^/]+\/domains(\/[^/]+)?$/,
  /^\/v9\/projects\/[^/]+\/env(\/[^/]+)?$/,
  /^\/v10\/projects\/[^/]+\/env$/,
  /^\/v5\/domains\/[^/]+$/,
  ...
  /^\/v1\/projects\/[^/]+\/logs$/,
  /^\/v1\/projects\/[^/]+\/web-vitals$/,
  /^\/v1\/projects\/[^/]+\/insights$/,
  /^\/v1\/projects\/[^/]+\/protection-bypass$/,
  /^\/v1\/data-cache\/purge-all$/,
  /^\/v1\/usage\/.+$/,
  /^\/v1\/integrations\/log-drains(\/[^/]+)?$/,
  /^\/v1\/integrations\/configurations$/,
  /^\/v1\/integrations\/billing\/usage$/,
  /^\/v1\/webhooks(\/[^/]+)?$/,
  /^\/v1\/edge-config$/,
  /^\/v1\/edge-config\/[^/]+(\/items)?$/,
  /^\/v1\/checks$/,
  /^\/v1\/deployments\/[^/]+\/checks(\/[^/]+)?$/,
  /^\/v1\/firewall\/configs\/[^/]+$/,
  /^\/v1\/security\/attack-status$/,
  /^\/v1\/access-groups(\/[^/]+)?$/,
];
